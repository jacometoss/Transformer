...
d1=5.3/100; 
d2=0.2/100; 
d3=0.463/100; //Distancia influye mucho, unidades metros.
d4=0.4/100;
d5=0.2/100;
//-----------------------------------------//
...
lrm=0.323/100; 
// .... ..... ..... .... .... .... .... .... .... .... .... .... //  
//lrm: Distancia sumada 1 vez para cada corte. (AA',BB') izquierdo
// o derecho. Ejemplo: La longitud de la ventana izquierda 
// corresponde lc + 1/2*lrm + 1/2*lrm que es igual a lc+lrm.
// .... ..... ..... .... .... .... .... .... .... .... .... .... // 
k1=abs(d1-d4);
k2=min(d1,d4);
...
disp (PW1CorteBB);
disp('****** Permeancia  Devanado Primario 127V Exterior Corte C-C (Un Radio, Esquina)********')
disp (PW1CorteCC);
